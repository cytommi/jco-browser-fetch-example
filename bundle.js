// node_modules/.pnpm/@bytecodealliance+preview2-shim@0.17.1/node_modules/@bytecodealliance/preview2-shim/lib/browser/io.js
var id = 0;
...
// node_modules/.pnpm/@bytecodealliance+preview2-shim@0.17.1/node_modules/@bytecodealliance/preview2-shim/lib/browser/filesystem.js
...
// node_modules/.pnpm/@bytecodealliance+preview2-shim@0.17.1/node_modules/@bytecodealliance/preview2-shim/lib/browser/cli.js
...
// node_modules/.pnpm/@bytecodealliance+preview2-shim@0.17.1/node_modules/@bytecodealliance/preview2-shim/lib/browser/clocks.js
var monotonicClock = {
  resolution() {
    return 1e6;
  },
...
// node_modules/.pnpm/@bytecodealliance+preview2-shim@0.17.1/node_modules/@bytecodealliance/preview2-shim/lib/browser/http.js
var outgoingHandler = {
  handle() {
  }
};
...
// node_modules/.pnpm/@bytecodealliance+preview2-shim@0.17.1/node_modules/@bytecodealliance/preview2-shim/lib/browser/random.js
var MAX_BYTES = 65536;
...
function rscTableRemove(table, handle2) {
  const scope = table[handle2 << 1];
  const val = table[(handle2 << 1) + 1];
  const own = (val & T_FLAG) !== 0;
  const rep = val & ~T_FLAG;
  if (val === 0 || (scope & T_FLAG) !== 0) throw new TypeError("Invalid handle");
  table[handle2 << 1] = table[0] | T_FLAG;
  table[0] = handle2 | T_FLAG;
...
var handleTable7 = [T_FLAG, 0];
var captureTable7 = /* @__PURE__ */ new Map();
var captureCnt7 = 0;
...
var handleTable8 = [T_FLAG, 0];
var captureTable8 = /* @__PURE__ */ new Map();
...
var handleTable10 = [T_FLAG, 0];
var captureTable10 = /* @__PURE__ */ new Map();
var captureCnt10 = 0;
...
var handleTable14 = [T_FLAG, 0];
var captureTable14 = /* @__PURE__ */ new Map();
var captureCnt14 = 0;
...
var handleTable13 = [T_FLAG, 0];
var captureTable13 = /* @__PURE__ */ new Map();
var captureCnt13 = 0;
...
var handleTable15 = [T_FLAG, 0];
var captureTable15 = /* @__PURE__ */ new Map();
var captureCnt15 = 0;
  ...
  if (variant5 === null || variant5 === void 0) {
    ...
    switch (variant4.tag) {
      ...
      case "other": {
        ...
        var ptr3 = utf8Encode(e2, realloc0, memory0);
        var len3 = utf8EncodedLen;
...
var handleTable9 = [T_FLAG, 0];
var captureTable9 = /* @__PURE__ */ new Map();
var captureCnt9 = 0;
...
var handleTable11 = [T_FLAG, 0];
var captureTable11 = /* @__PURE__ */ new Map();
var captureCnt11 = 0;
...
var handleTable12 = [T_FLAG, 0];
var captureTable12 = /* @__PURE__ */ new Map();
  ...
  switch (variant45.tag) {
    ...
    case "err": {
      ...
      switch (variant44.tag) {
        ...
        case "DNS-error": {
          const e2 = variant44.val;
          dataView(memory0).setInt8(arg3 + 8, 1, true);
          var { rcode: v7_0, infoCode: v7_1 } = e2;
          var variant9 = v7_0;
          if (variant9 === null || variant9 === void 0) {
            ...
            var ptr8 = utf8Encode(e3, realloc0, memory0);
          ...
          if (variant10 === null || variant10 === void 0) {
            ...
            dataView(memory0).setInt16(arg3 + 30, toUint16(e3), true);
          }
          break;
        }
        ...
        case "TLS-alert-received": {
          ...
          var { alertId: v11_0, alertMessage: v11_1 } = e2;
          var variant12 = v11_0;
          if (variant12 === null || variant12 === void 0) {
            ...
            const e3 = variant12;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            dataView(memory0).setInt8(arg3 + 17, toUint8(e3), true);
          }
          var variant14 = v11_1;
          if (variant14 === null || variant14 === void 0) {
            ...
            var ptr13 = utf8Encode(e3, realloc0, memory0);
        ...
        case "HTTP-request-body-size": {
          ...
          if (variant15 === null || variant15 === void 0) {
            ...
            const e3 = variant15;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            dataView(memory0).setBigInt64(arg3 + 24, toUint64(e3), true);
          }
          break;
        }
        ...
        case "HTTP-request-header-section-size": {
          ...
          if (variant16 === null || variant16 === void 0) {
            ...
            const e3 = variant16;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            dataView(memory0).setInt32(arg3 + 20, toUint32(e3), true);
          }
          break;
        }
        case "HTTP-request-header-size": {
          ...
          if (variant21 === null || variant21 === void 0) {
            ...
            const e3 = variant21;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            var { fieldName: v17_0, fieldSize: v17_1 } = e3;
            var variant19 = v17_0;
            if (variant19 === null || variant19 === void 0) {
              ...
              const e4 = variant19;
              dataView(memory0).setInt8(arg3 + 20, 1, true);
              var ptr18 = utf8Encode(e4, realloc0, memory0);
            ...
            if (variant20 === null || variant20 === void 0) {
              ...
              dataView(memory0).setInt32(arg3 + 36, toUint32(e4), true);
            }
          }
          break;
        }
        ...
        case "HTTP-request-trailer-size": {
          ...
          var { fieldName: v23_0, fieldSize: v23_1 } = e2;
          var variant25 = v23_0;
          if (variant25 === null || variant25 === void 0) {
            dataView(memory0).setInt8(arg3 + 16, 0, true);
          } else {
            const e3 = variant25;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            var ptr24 = utf8Encode(e3, realloc0, memory0);
            var len24 = utf8EncodedLen;
            dataView(memory0).setInt32(arg3 + 24, len24, true);
            dataView(memory0).setInt32(arg3 + 20, ptr24, true);
          }
          var variant26 = v23_1;
          if (variant26 === null || variant26 === void 0) {
            dataView(memory0).setInt8(arg3 + 28, 0, true);
          } else {
            const e3 = variant26;
            dataView(memory0).setInt8(arg3 + 28, 1, true);
            dataView(memory0).setInt32(arg3 + 32, toUint32(e3), true);
          }
          break;
        }
        ...
        case "HTTP-response-header-section-size": {
          ...
          var variant27 = e2;
          if (variant27 === null || variant27 === void 0) {
            dataView(memory0).setInt8(arg3 + 16, 0, true);
          } else {
            const e3 = variant27;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
        ...
        case "HTTP-response-header-size": {
          ...
          var { fieldName: v28_0, fieldSize: v28_1 } = e2;
          var variant30 = v28_0;
          if (variant30 === null || variant30 === void 0) {
            ...
            const e3 = variant30;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            var ptr29 = utf8Encode(e3, realloc0, memory0);
        ...
        case "HTTP-response-body-size": {
          ...
          var variant32 = e2;
          if (variant32 === null || variant32 === void 0) {
            dataView(memory0).setInt8(arg3 + 16, 0, true);
          } else {
            const e3 = variant32;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
        ...
        case "HTTP-response-trailer-section-size": {
          ...
          var variant33 = e2;
          if (variant33 === null || variant33 === void 0) {
            dataView(memory0).setInt8(arg3 + 16, 0, true);
          } else {
            const e3 = variant33;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
        ...
        case "HTTP-response-trailer-size": {
          ...
          var { fieldName: v34_0, fieldSize: v34_1 } = e2;
          var variant36 = v34_0;
          if (variant36 === null || variant36 === void 0) {
            dataView(memory0).setInt8(arg3 + 16, 0, true);
          } else {
            const e3 = variant36;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            var ptr35 = utf8Encode(e3, realloc0, memory0);
            var len35 = utf8EncodedLen;
            dataView(memory0).setInt32(arg3 + 24, len35, true);
            dataView(memory0).setInt32(arg3 + 20, ptr35, true);
          }
          var variant37 = v34_1;
          if (variant37 === null || variant37 === void 0) {
            dataView(memory0).setInt8(arg3 + 28, 0, true);
          } else {
            const e3 = variant37;
            dataView(memory0).setInt8(arg3 + 28, 1, true);
        ...
        case "HTTP-response-transfer-coding": {
          ...
          var variant39 = e2;
          if (variant39 === null || variant39 === void 0) {
            dataView(memory0).setInt8(arg3 + 16, 0, true);
          } else {
            const e3 = variant39;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            var ptr38 = utf8Encode(e3, realloc0, memory0);
        ...
        case "HTTP-response-content-coding": {
          ...
          var variant41 = e2;
          if (variant41 === null || variant41 === void 0) {
            dataView(memory0).setInt8(arg3 + 16, 0, true);
          } else {
            const e3 = variant41;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            var ptr40 = utf8Encode(e3, realloc0, memory0);
        ...
        case "internal-error": {
          ...
          var variant43 = e2;
          if (variant43 === null || variant43 === void 0) {
            dataView(memory0).setInt8(arg3 + 16, 0, true);
          } else {
            const e3 = variant43;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            var ptr42 = utf8Encode(e3, realloc0, memory0);
...
function trampoline56(arg0, arg1) {
  ...
  curResourceBorrows = [];
  var variant44 = ret;
  if (variant44 === null || variant44 === void 0) {
    dataView(memory0).setInt8(arg1 + 0, 0, true);
  } else {
    const e = variant44;
    dataView(memory0).setInt8(arg1 + 0, 1, true);
    ...
    switch (variant43.tag) {
      case "ok": {
        const e2 = variant43.val;
        dataView(memory0).setInt8(arg1 + 8, 0, true);
        var variant42 = e2;
        switch (variant42.tag) {
          case "ok": {
            const e3 = variant42.val;
            dataView(memory0).setInt8(arg1 + 16, 0, true);
            if (!(e3 instanceof IncomingResponse)) {
              throw new TypeError('Resource error: Not a valid "IncomingResponse" resource.');
            }
            var handle3 = e3[symbolRscHandle];
            if (!handle3) {
              const rep = e3[symbolRscRep] || ++captureCnt14;
              captureTable14.set(rep, e3);
          ...
          case "err": {
            ...
            switch (variant41.tag) {
              ...
              case "DNS-error": {
                const e4 = variant41.val;
                dataView(memory0).setInt8(arg1 + 24, 1, true);
                var { rcode: v4_0, infoCode: v4_1 } = e4;
                var variant6 = v4_0;
                if (variant6 === null || variant6 === void 0) {
                  ...
                  var ptr5 = utf8Encode(e5, realloc0, memory0);
                ...
                if (variant7 === null || variant7 === void 0) {
                  ...
                  dataView(memory0).setInt16(arg1 + 46, toUint16(e5), true);
                }
                break;
              }
              case "destination-not-found": {
              ...
              case "TLS-alert-received": {
                ...
                var { alertId: v8_0, alertMessage: v8_1 } = e4;
                var variant9 = v8_0;
                if (variant9 === null || variant9 === void 0) {
                  dataView(memory0).setInt8(arg1 + 32, 0, true);
                } else {
                  const e5 = variant9;
                  dataView(memory0).setInt8(arg1 + 32, 1, true);
                  dataView(memory0).setInt8(arg1 + 33, toUint8(e5), true);
                }
                var variant11 = v8_1;
                if (variant11 === null || variant11 === void 0) {
                  ...
                  var ptr10 = utf8Encode(e5, realloc0, memory0);
              ...
              case "HTTP-request-body-size": {
                ...
                if (variant12 === null || variant12 === void 0) {
                  ...
                  const e5 = variant12;
                  dataView(memory0).setInt8(arg1 + 32, 1, true);
                  dataView(memory0).setBigInt64(arg1 + 40, toUint64(e5), true);
                }
                break;
              }
              case "HTTP-request-method-invalid": {
              ...
              case "HTTP-request-header-section-size": {
                ...
                if (variant13 === null || variant13 === void 0) {
                  ...
                  const e5 = variant13;
                  dataView(memory0).setInt8(arg1 + 32, 1, true);
                  dataView(memory0).setInt32(arg1 + 36, toUint32(e5), true);
                }
                break;
              }
              case "HTTP-request-header-size": {
                ...
                if (variant18 === null || variant18 === void 0) {
                  ...
                  const e5 = variant18;
                  dataView(memory0).setInt8(arg1 + 32, 1, true);
                  var { fieldName: v14_0, fieldSize: v14_1 } = e5;
                  var variant16 = v14_0;
                  if (variant16 === null || variant16 === void 0) {
                    dataView(memory0).setInt8(arg1 + 36, 0, true);
                  } else {
                    const e6 = variant16;
                    dataView(memory0).setInt8(arg1 + 36, 1, true);
                    var ptr15 = utf8Encode(e6, realloc0, memory0);
                  ...
                  if (variant17 === null || variant17 === void 0) {
                    ...
                    dataView(memory0).setInt32(arg1 + 52, toUint32(e6), true);
                  }
                }
                break;
              }
              ...
              case "HTTP-request-trailer-size": {
                ...
                var { fieldName: v20_0, fieldSize: v20_1 } = e4;
                var variant22 = v20_0;
                if (variant22 === null || variant22 === void 0) {
                  dataView(memory0).setInt8(arg1 + 32, 0, true);
                } else {
                  const e5 = variant22;
                  dataView(memory0).setInt8(arg1 + 32, 1, true);
                  var ptr21 = utf8Encode(e5, realloc0, memory0);
                  var len21 = utf8EncodedLen;
                  dataView(memory0).setInt32(arg1 + 40, len21, true);
                  dataView(memory0).setInt32(arg1 + 36, ptr21, true);
                }
                var variant23 = v20_1;
                if (variant23 === null || variant23 === void 0) {
                  dataView(memory0).setInt8(arg1 + 44, 0, true);
                } else {
                  const e5 = variant23;
                  dataView(memory0).setInt8(arg1 + 44, 1, true);
                  dataView(memory0).setInt32(arg1 + 48, toUint32(e5), true);
                }
                break;
              }
              case "HTTP-response-incomplete": {
              ...
              case "HTTP-response-header-section-size": {
                ...
                var variant24 = e4;
                if (variant24 === null || variant24 === void 0) {
                  dataView(memory0).setInt8(arg1 + 32, 0, true);
                } else {
                  const e5 = variant24;
                  dataView(memory0).setInt8(arg1 + 32, 1, true);
              ...
              case "HTTP-response-header-size": {
                ...
                var { fieldName: v25_0, fieldSize: v25_1 } = e4;
                var variant27 = v25_0;
                if (variant27 === null || variant27 === void 0) {
                  dataView(memory0).setInt8(arg1 + 32, 0, true);
                } else {
              ...
              case "HTTP-response-trailer-size": {
                ...
                var { fieldName: v31_0, fieldSize: v31_1 } = e4;
                var variant33 = v31_0;
                if (variant33 === null || variant33 === void 0) {
                  dataView(memory0).setInt8(arg1 + 32, 0, true);
                } else {
              ...
              case "HTTP-response-transfer-coding": {
                ...
                if (variant36 === null || variant36 === void 0) {
                  ...
                  const e5 = variant36;
                  dataView(memory0).setInt8(arg1 + 32, 1, true);
                  var ptr35 = utf8Encode(e5, realloc0, memory0);
                  var len35 = utf8EncodedLen;
              ...
              case "HTTP-response-content-coding": {
                ...
                var variant38 = e4;
                if (variant38 === null || variant38 === void 0) {
                  dataView(memory0).setInt8(arg1 + 32, 0, true);
                } else {
                  const e5 = variant38;
                  dataView(memory0).setInt8(arg1 + 32, 1, true);
                  var ptr37 = utf8Encode(e5, realloc0, memory0);
              ...
              case "internal-error": {
                ...
                var variant40 = e4;
                if (variant40 === null || variant40 === void 0) {
                  dataView(memory0).setInt8(arg1 + 32, 0, true);
                } else {
                  const e5 = variant40;
                  dataView(memory0).setInt8(arg1 + 32, 1, true);
                  var ptr39 = utf8Encode(e5, realloc0, memory0);
...
var handleTable16 = [T_FLAG, 0];
var captureTable16 = /* @__PURE__ */ new Map();
  ...
  switch (variant46.tag) {
    ...
    case "err": {
      ...
      switch (variant45.tag) {
        ...
        case "DNS-error": {
          const e2 = variant45.val;
          dataView(memory0).setInt8(arg3 + 8, 1, true);
          var { rcode: v8_0, infoCode: v8_1 } = e2;
          var variant10 = v8_0;
          if (variant10 === null || variant10 === void 0) {
            dataView(memory0).setInt8(arg3 + 16, 0, true);
          } else {
            const e3 = variant10;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            var ptr9 = utf8Encode(e3, realloc0, memory0);
        ...
        case "TLS-alert-received": {
          const e2 = variant45.val;
          dataView(memory0).setInt8(arg3 + 8, 14, true);
          var { alertId: v12_0, alertMessage: v12_1 } = e2;
          var variant13 = v12_0;
          if (variant13 === null || variant13 === void 0) {
            dataView(memory0).setInt8(arg3 + 16, 0, true);
          } else {
          ...
          if (variant15 === null || variant15 === void 0) {
            ...
            const e3 = variant15;
            dataView(memory0).setInt8(arg3 + 20, 1, true);
            var ptr14 = utf8Encode(e3, realloc0, memory0);
        ...
        case "HTTP-request-header-size": {
          ...
          if (variant22 === null || variant22 === void 0) {
            ...
            const e3 = variant22;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            var { fieldName: v18_0, fieldSize: v18_1 } = e3;
            var variant20 = v18_0;
            if (variant20 === null || variant20 === void 0) {
              dataView(memory0).setInt8(arg3 + 20, 0, true);
            } else {
              const e4 = variant20;
              dataView(memory0).setInt8(arg3 + 20, 1, true);
              var ptr19 = utf8Encode(e4, realloc0, memory0);
        ...
        case "HTTP-request-trailer-size": {
          const e2 = variant45.val;
          dataView(memory0).setInt8(arg3 + 8, 24, true);
          var { fieldName: v24_0, fieldSize: v24_1 } = e2;
          var variant26 = v24_0;
          if (variant26 === null || variant26 === void 0) {
            dataView(memory0).setInt8(arg3 + 16, 0, true);
          } else {
            const e3 = variant26;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            var ptr25 = utf8Encode(e3, realloc0, memory0);
        ...
        case "HTTP-response-header-size": {
          const e2 = variant45.val;
          dataView(memory0).setInt8(arg3 + 8, 27, true);
          var { fieldName: v29_0, fieldSize: v29_1 } = e2;
          var variant31 = v29_0;
          if (variant31 === null || variant31 === void 0) {
            dataView(memory0).setInt8(arg3 + 16, 0, true);
          } else {
            const e3 = variant31;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            var ptr30 = utf8Encode(e3, realloc0, memory0);
        ...
        case "HTTP-response-trailer-size": {
          const e2 = variant45.val;
          dataView(memory0).setInt8(arg3 + 8, 30, true);
          var { fieldName: v35_0, fieldSize: v35_1 } = e2;
          var variant37 = v35_0;
          if (variant37 === null || variant37 === void 0) {
            dataView(memory0).setInt8(arg3 + 16, 0, true);
          } else {
            const e3 = variant37;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            var ptr36 = utf8Encode(e3, realloc0, memory0);
        ...
        case "HTTP-response-transfer-coding": {
          ...
          if (variant40 === null || variant40 === void 0) {
            ...
            const e3 = variant40;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            var ptr39 = utf8Encode(e3, realloc0, memory0);
            var len39 = utf8EncodedLen;
        ...
        case "HTTP-response-content-coding": {
          ...
          dataView(memory0).setInt8(arg3 + 8, 32, true);
          var variant42 = e2;
          if (variant42 === null || variant42 === void 0) {
            dataView(memory0).setInt8(arg3 + 16, 0, true);
          } else {
            const e3 = variant42;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            var ptr41 = utf8Encode(e3, realloc0, memory0);
        ...
        case "internal-error": {
          ...
          if (variant44 === null || variant44 === void 0) {
            ...
            const e3 = variant44;
            dataView(memory0).setInt8(arg3 + 16, 1, true);
            var ptr43 = utf8Encode(e3, realloc0, memory0);
...
function trampoline0(handle2) {
  const handleEntry = rscTableRemove(handleTable1, handle2);
  if (handleEntry.own) {
...
function trampoline1(handle2) {
  const handleEntry = rscTableRemove(handleTable3, handle2);
  if (handleEntry.own) {
...
function trampoline19(handle2) {
  const handleEntry = rscTableRemove(handleTable0, handle2);
  if (handleEntry.own) {
...
function trampoline20(handle2) {
  const handleEntry = rscTableRemove(handleTable2, handle2);
  if (handleEntry.own) {
...
function trampoline21(handle2) {
  const handleEntry = rscTableRemove(handleTable6, handle2);
  if (handleEntry.own) {
...
function trampoline23(handle2) {
  const handleEntry = rscTableRemove(handleTable4, handle2);
  if (handleEntry.own) {
...
function trampoline24(handle2) {
  const handleEntry = rscTableRemove(handleTable5, handle2);
  if (handleEntry.own) {
